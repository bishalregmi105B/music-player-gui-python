...
class MainWindow(QMainWindow):
	...
	def homeScreen(self):
		...
		self.setWindowTitle('Music Player by Ashlya Tech')
	...
	def createMenubar(self):
		...
		social = menubar.addMenu('Social Media')
		social.addAction(self.openyoutube())
		social.addAction(self.openfb())
		
		social.addAction(self.opentelegram())
	...
	def openyoutube(self):
		fileAc = QAction('Open Youtube Channel',self)
		fileAc.setShortcut('Ctrl+y')
		fileAc.setStatusTip('Open Youtube Channel')
		fileAc.triggered.connect(self.openFile)
		return fileAc

	def openfb(self):
		fileAc = QAction('Open Facebook Page',self)
		fileAc.setShortcut('Ctrl+f')
		fileAc.setStatusTip('Open Facebook Page')
		fileAc.triggered.connect(self.openFile)
		return fileAc
	def opentelegram(self):
		fileAc = QAction('Open Telegram',self)
		fileAc.setShortcut('Ctrl+t')
		fileAc.setStatusTip('Open Telegram Channel')
		fileAc.triggered.connect(self.openFile)
		return fileAc
